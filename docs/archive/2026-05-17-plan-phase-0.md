...
archived_in: docs(s0/T2) archive raíz legacy files (sprint S0 production-readiness)
superseded_by:
  - .specs/production-readiness/spec.md
  - .specs/production-readiness/roadmap.md
  - docs/adr/042-stakeholder-geo-aggregations-comuna-filter-and-domain-alignment.md
  - docs/adr/043-drift-schema-domain.md
  - CLAUDE.md (sección "Reglas de naming bilingüe")
archived_reason: |
  Plan inicial Phase-0 de reconciliación schemas + ESG foundational (greenfield
  pre-implementación). Sus reglas bilingües están en CLAUDE.md como contrato
  vivo; sus decisiones de schema/domain quedaron capturadas en ADR-042/043;
  el roadmap de fases siguientes es .specs/production-readiness/roadmap.md.
status: archived
---

# PLAN-PHASE-0 — Reconciliación de schemas (bilingüe TS/SQL + ESG foundational) (ARCHIVADO)
