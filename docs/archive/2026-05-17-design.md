...
superseded_by:
  - packages/ui-tokens/ (sistema técnico de tokens, mencionado ya en el doc original)
  - design-system/MASTER.md (a producir cuando arranque el flujo /design del agent-rigor)
  - docs/handoff/CURRENT.md
archived_reason: |
  Brief de marca + producto del 2026-04-30 (pre-launch 2026-05-04). La identidad
  de marca se mantiene en uso pero el contrato visual se desplazó a
  packages/ui-tokens/. El design-system/MASTER.md (canónico futuro) se generará
  en el flujo /design del agent-rigor cuando arranque el sprint de UI/UX.
status: archived
---

# DESIGN.md — Brief de marca y producto Booster AI (ARCHIVADO)
