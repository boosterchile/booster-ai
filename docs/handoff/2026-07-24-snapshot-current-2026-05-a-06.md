# Snapshot archivado de CURRENT.md — sesiones 2026-05-17 → 2026-06-22

> Archivado el 2026-07-24 al **compactar** `docs/handoff/CURRENT.md` (convención del contrato: CURRENT.md ~150 líneas; el detalle vive en snapshots fechados). Contiene las sesiones desde la *Ventana 2026-06-22* hacia atrás hasta 2026-05-17 (SEC-001, sprints S0/S1a, D11 v1/v2, incidentes Redis TLS y CI/CD, cost-opt ADR-058, migración agent-rigor→superpowers, F4 documental, etc.). Es **contenido histórico** tal cual estaba en CURRENT.md — NO refleja el estado vigente (ver `CURRENT.md` para eso).
