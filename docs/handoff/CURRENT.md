...
El PO decidió sobre los 8: **los 8 originales quedaron CERRADOS sin merge**; los 6 rescatables reviven como PR fresco (rebase/rehecho desde main), los 2 irrescatables se cerraron definitivamente. **Ninguno de los sucesores está mergeado todavía** — siguen abiertos esperando merge del PO.
...
| **#516** booleanFlag de @booster-ai/config | REHACER | **#630** ABIERTO (CLEAN, 24 checks verdes) | rehecho fresco: 2 archivos, api 1814/1814. El original conflictuaba contra el `release.yml` reescrito a dispatch-only |
