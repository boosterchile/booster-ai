...
**Tipo**: deuda documental / contrato. **Riesgo**: medio (no externo, no explotable). **Estado**: ✅ **CERRADO 2026-06-03** — (1) escrito [`docs/adr/056-cicd-github-actions-supersedes-gitlab.md`](../../docs/adr/056-cicd-github-actions-supersedes-gitlab.md) que supersede ADR-020; (2) ADR-020 anotado con marcador `Superseded by ADR-056` en su `Status` (con OK explícito del PO). Nada pendiente.
