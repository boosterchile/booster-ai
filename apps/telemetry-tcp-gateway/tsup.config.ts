...
/**
 * Tsup config para apps/telemetry-tcp-gateway.
 *
 * `noExternal` con @booster-ai/* fuerza a tsup a INCLUIR los workspace packages
 * dentro del bundle final. Sin esto, dist/main.js hace `import '@booster-ai/codec8-parser'`
 * y Node intenta resolver a node_modules/@booster-ai/codec8-parser/src/index.ts
