-- =============================================================================
-- REVERSE-SQL MANUAL — 0053_bitacora_backfill_distancia (ADR-066)
-- =============================================================================
...
--   AUTH_MODE=password bash scripts/db/connect.sh -f apps/api/drizzle/down/0053_bitacora_backfill_distancia.down.sql
--
