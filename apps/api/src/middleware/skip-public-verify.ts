 ...
 * método/path nativamente; este wrapper es el patrón único de los
 * middlewares del chain (firebaseAuth, userContext) — antes eran lambdas
 * duplicadas inline en server.ts.
 */
