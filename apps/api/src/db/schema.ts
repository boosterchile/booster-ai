...
export const zonasStakeholder = pgTable(
  'zonas_stakeholder',
  {
    ...
    latMin: numeric('lat_min', { precision: 10, scale: 7, mode: 'number' }).notNull(),
    latMax: numeric('lat_max', { precision: 10, scale: 7, mode: 'number' }).notNull(),
    lngMin: numeric('lng_min', { precision: 10, scale: 7, mode: 'number' }).notNull(),
    lngMax: numeric('lng_max', { precision: 10, scale: 7, mode: 'number' }).notNull(),
    comunaCodes: text('comuna_codes').array().notNull().default(sql`ARRAY[]::text[]`),
