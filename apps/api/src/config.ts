...
// `booleanFlag` (parser explícito true/false, evita el footgun de
// z.coerce.boolean) vive en @booster-ai/config — la copia local idéntica que
// había acá se eliminó (convergencia, claude-md-referencias-stale ítem técnico).
